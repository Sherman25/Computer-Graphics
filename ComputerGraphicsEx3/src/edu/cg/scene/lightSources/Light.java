...
public abstract class Light {
	 ...
	 */
	public abstract boolean isOccludedBy(Ray rayToLight, Hit hit, List<Surface> surfaces);
	
	//public abstract double getOcclusionFactor(Point fromPoint, Scene scene);
	 ...
	 */
	public abstract Vec intensityDiffuse(Point hittingPoint, Ray rayToLight);
	
	public abstract Vec intensitySpecular(Point hittingPoint, Ray rayToLight);
